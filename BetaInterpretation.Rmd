...
I decided to create a post where I could share a simple and intuitive interpretation of the coefficients of a linear regression. I came to this conclusion, simply because I was surprised of NOT finding any document that explores the expression $\hat\beta = (X^TX)^{-1}X^TY$ as I will do in the present work.
...
The starting point is: $\hat\beta = (X^TX)^{-1}X^TY$...what is $(X^TX)^{-1}X^TY$?
